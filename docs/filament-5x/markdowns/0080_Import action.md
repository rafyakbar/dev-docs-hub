...
Filament\Actions\Imports\ImportColumn

The current import column instance.
...
The processed data for the record that is currently being imported.
...
The instance of the importer class that is currently being used for importing data.
...
The options that were defined when the import started.
...
The original data for the record that is currently being imported, before it was processed.
...
The Eloquent record that is currently being imported.
...
The state to cast, before it was processed by other casting methods.
...
The state to cast, after it has been processed by other casting methods.
...
The state to resolve into a record.
...
The state to fill into the record.
...
[Edit this page on GitHub](https://github.com/filamentphp/filament/edit/5.x/packages/actions/docs/11-import.md)
